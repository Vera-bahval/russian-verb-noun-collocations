...
if __name__ == "__main__":
    ...
    prompt_fill_sent = '''Ты - помощник, специализирующийся на русских устойчивых словосочетаниях. Твоя задача - заполнить пропуск [MASK] в предложении УСТОЙЧИВЫМ СОЧЕТАНИЕМ, состоящим из ГЛАГОЛА и СУЩЕСТВИТЕЛЬНОГО.
